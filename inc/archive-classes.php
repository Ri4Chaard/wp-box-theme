...
<div class="flex justify-between items-center mt-4">
    ...
    <div class="absolute right-0 bottom-12 flex items-center gap-[12px]">
        <button id="prev-btn" class="w-[60px] h-[60px] flex items-center justify-center border-2 border-red-600 text-red-600 bg-transparent disabled:border-gray-500 disabled:text-gray-500">
        ...
        <button id="next-btn" class="w-[60px] h-[60px] flex items-center justify-center border-2 border-red-600 text-red-600 bg-transparent disabled:border-gray-500 disabled:text-gray-500">
